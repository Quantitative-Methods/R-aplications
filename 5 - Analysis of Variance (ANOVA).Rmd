...
Utvrđuje dali se aritmetičke sredine dvaju ili više nezavisnih uzoraka statistički značajno razlikuju.

**Hipoteze:**

- Nulta hipoteza H0: Razlike između aritmetičkih sredina dvaju ili više uzoraka nisu statistički značajna uz pogrešku p.

- Alternativna hipoteza H1: Razlike između aritmetičkih sredina dvaju ili više uzoraka statistički su značajne uz pogrešku p.
...
- Provjeriti dali se distiribucije zavisnih varijabli statistički značajno razlikuju od normalne ili Gaussove (Shapiro-Wilk's Test). Ako je razlika statistički značajna onda je potrebno koristi ekvivalentan neparametrijski test (Kruskal–Wallis analysis of variance).
